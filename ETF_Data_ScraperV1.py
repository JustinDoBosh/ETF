...
class excelSetup:
	...
	def etfInfoSetup(self):
		...
		worksheetToWriteTo.set_column('A:E', 30)
		#Add formating
		...
		# Write some data headers.
 		...
 		worksheetToWriteTo.write('B1', 'Time Stamp', format)
 		worksheetToWriteTo.write('C1', 'Efficiency', format)
 		worksheetToWriteTo.write('D1', 'Tradability', format)
 		worksheetToWriteTo.write('E1', 'Fit', format)
